...
<template>
    <GuestLayout>
        ...
        <form @submit.prevent="onSubmit" class="flex flex-col gap-3 h-64 pt-5 overflow-visible">
            <!-- PATIENT NAME INPUT -->
            <!-- <div>
                ...
                <Listbox v-model="form.priority_type">
                    <div class="relative mt-1">
                        ...
                        >
                            ...
                            >
                                <ListboxOptions
                                    class="absolute mt-1 max-h-28 z-50 w-full overflow-y-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm"
                                >
                                    <ListboxOption
