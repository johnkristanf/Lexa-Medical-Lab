<script setup>
    ...
    function submitForm() {
        ...
        console.log('Submitting User edit:', formData.value)

        router.put(
            route('admin.user.update', props.user.id), // Adjust the route as per your backend
            formData.value,
            {
                preserveScroll: true,
                onSuccess: (page) => {
                            ...
                            <form @submit.prevent="submitForm" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">
                                        Leave this blank to keep the current password. Minimum 6
