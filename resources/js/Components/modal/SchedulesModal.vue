<script setup>
    ...
    import { FwbBadge, FwbDropdown, FwbListGroup, FwbListGroupItem, FwbButton } from 'flowbite-vue'
                        ...
                        >
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <DialogDescription
                                        class="text-sm font-medium leading-6 text-gray-400 mt-1"
                                    >
                                        Manage your appointment schedules and time slots
                                    </DialogDescription>
                                </div>

                                <AddButton class="flex" color="green" @click="openAddScheduleModal">
                                    <svg
                                        class="w-4 h-4 mr-2"
                                        fill="none"
                                        stroke="currentColor"
                            ...
                            <div class="max-h-96 overflow-y-auto space-y-4 pr-2">
                                ...
                                >
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div class="flex space-x-1">
                                                    <fwb-badge
                                                        v-for="slot in schedule.appointment_slots?.slice(
                                                            0,
                                                            4,
                                                        )"
                                                        :key="slot.id"
                                    ...
                                    >
                                        ...
                                        <div
                                            v-if="schedule.appointment_slots?.length"
                                    ...
                                    <div class="flex flex-col items-center space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-500">
                                                Get started by creating your first schedule with
                                                time slots.
                                            </p>
                                        </div>
                                        <AddButton color="green" @click="openAddScheduleModal">
                                            <svg
                                                class="w-4 h-4 mr-2"
                                                fill="none"
                                                stroke="currentColor"
