...
const navigationLinks = computed(() => [
  ...
  // INVENTORY / SUPPLIES
  { name: 'Inventory', route_name: 'inventory.supplies', permitted: permissions.value?.can_manage_inventory_supplies },
  { name: 'Supplies', route_name: 'supplies.create.page', permitted: permissions.value?.can_manage_inventory_supplies },
  { name: 'Supply Requests', route_name: 'inventory.supply.request', permitted: permissions.value?.can_manage_inventory_supplies },
  { name: 'Stock', route_name: 'medical.stock.create', permitted: permissions.value?.can_manage_inventory_supplies },
  { name: 'Category', route_name: 'category.supplies.create', permitted: permissions.value?.can_manage_inventory_supplies },
